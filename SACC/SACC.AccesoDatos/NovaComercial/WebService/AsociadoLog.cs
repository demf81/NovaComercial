...
{
    public class AsociadoLog : Conexion.ConexionSQL
    {
        public AsociadoLog()
        {
        ...
        public Entidades.EntidadResponse Consultar(short Opcion, Entidades.NovaComercial.WebService.AsociadoLog oBE)
        {
            Entidades.EntidadResponse oEntidadResponse = new Entidades.EntidadResponse();

            try
            {
                oComando.CommandText = "WebService.spAspciadoLog_Consultar";
                ...
                oComando.Parameters.AddRange(
                    new SqlParameter[] {
                        ...
                        new SqlParameter("@AsociadoLogId",             oBE.AsociadoId),
        ...
        public Entidades.EntidadResponse Insertar(short Opcion, Entidades.NovaComercial.WebService.AsociadoLog oBE)
        {
            Entidades.EntidadResponse oEntidadResponse = new Entidades.EntidadResponse();

            try
            {
                oComando.CommandText = "WebService.spAsociadoLog_Insertar";
                oComando.CommandType = System.Data.CommandType.StoredProcedure;
                oComando.Parameters.Clear();
        ...
        public Entidades.EntidadResponse Actualizar(short Opcion, Entidades.NovaComercial.WebService.AsociadoLog oBE)
        {
            Entidades.EntidadResponse oEntidadResponse = new Entidades.EntidadResponse();

            try
            {
                oComando.CommandText = "WebService.spAsociadoLog_Actualizar";
                oComando.CommandType = System.Data.CommandType.StoredProcedure;
                oComando.Parameters.Clear();
                ...
                oComando.Parameters.AddRange(
                    new SqlParameter[] {
                        new SqlParameter("@Opcion",                    Opcion),
                        new SqlParameter("@AsociadoId",                oBE.AsociadoId),
                        new SqlParameter("@AsociadoDescripcion",       oBE.AsociadoDescripcion),
                        new SqlParameter("@NumeroSocio",               oBE.NumeroSocio),
                        new SqlParameter("@ClaveFamiliar",             oBE.ClaveFamiliar),
                        new SqlParameter("@Nombre",                    oBE.Nombre),
                        new SqlParameter("@Paterno",                   oBE.Paterno),
