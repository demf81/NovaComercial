...
namespace SACC.Modelo.NovaComercial.SACC.CotizacionDetalle
{
    public class DtoGridCotizacionDetalleConPrecio : DtoGridCotizacionDetalle
    {
        public DtoGridCotizacionDetalleConPrecio()
        {
