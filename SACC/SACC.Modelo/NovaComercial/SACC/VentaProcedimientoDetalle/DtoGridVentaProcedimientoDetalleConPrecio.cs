...
namespace SACC.Modelo.NovaComercial.SACC.VentaProcedimientoDetalle
{
    public class DtoGridVentaProcedimientoDetalleConPrecio
    {
        public DtoGridVentaProcedimientoDetalleConPrecio()
        {
            _VentaProcedimientoDetalleId = 0;
            _VentaDetalleId              = 0;
            _VentaId                     = 0;
            _ServicioId                  = 0;
            _Posicion                    = 0;
        ...
        Int32 _VentaProcedimientoDetalleId;
        public Int32 VentaProcedimientoDetalleId { get { return _VentaProcedimientoDetalleId; } set { _VentaProcedimientoDetalleId = value; } }
