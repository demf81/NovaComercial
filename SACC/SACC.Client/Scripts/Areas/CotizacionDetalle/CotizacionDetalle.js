var CotizacionDetalleView = {
    evento:     null,
    inicializa: function (evento) {
        this.evento = evento;

        if (this.evento == 'COTIZACION_DETALLE_VIEW_INDEX') {
    ...
    tabla: {
        inicializa: function () {
            $('#dgDatosCotizacionDetalleView').bootstrapTable({
                pagination: true,
                search:     false,
                columns: [
                    {
        ...
        datos: function () {
            var objJSON = {
                ...
                pCotizacionId:        $('#txtModalCotizacionId').val(),
                pEstatusId:           1
            };
            ...
            $('#dgDatosCotizacionDetalleView').bootstrapTable("load", res.data.Datos);
