var CtrlUserVentaProcedimientoDetalle = {
    ...
    tabla: {
        inicializa: function () {
            $('#dgDatosVentaProcedimientoDetalle .editable').editable('toggleDisabled');

            $('#dgDatosVentaProcedimientoDetalle').bootstrapTable({
                pagination: false,
                search:     false,
                columns: [
                    {
        ...
        datos: function (procedimeintoId, procedimientoDescripcion, data) {
            $('#dgDatosVentaProcedimientoDetalle').bootstrapTable("load", data);
        },
    },
    tablaEdit: {
        inicializa: function () {
            ...
            $('#dgDatosVentaProcedimientoDetalle').bootstrapTable({
                ...
                columns: [
                    {
                        field:     'VentaProcedimientoDetalleId',
                        title:     'Folio',
                        sortable:  true,
                        align:     'center'
                    },
...
$('#dgDatosVentaProcedimientoDetalle').on('editable-save.bs.table', function (e, field, renglon, old, $el) {
    if (field == "Cantidad") {
        ...
        var $table = $('#dgDatosVentaProcedimientoDetalle');
